...
(() => {
  ...
  // src/utils/animations/home/introParallax.ts
  init_live_reload();
  var initIntroParallax = () => {
  ...
  // src/utils/animations/home/servicesParallax.ts
  init_live_reload();
  var initServicesParallax = () => {
  ...
  var initWorksParallax = () => {
    ...
    if (heroSection) {
      gsapWithCSS.set([heroSection, heroLogo], { y: "0rem" });
  ...
  var setupLogoHover = () => {
    const logoComponent = document.body.querySelector(".logo-component");
    const logo = document.body.querySelector(".logo-svg.is-s");
  ...
  init_live_reload();
  var animFooter = (rootSelector = ".section_footer") => {
    const prefersReducedMotion = window.matchMedia("(prefers-reduced-motion: reduce)");
    if (prefersReducedMotion.matches) return () => {
    };
    ...
    const card = root.querySelector(".footer_cards");
    const media = root.querySelector(".footer_cards-asset");
  ...
  import_core.default.hooks.afterEnter(() => {
    requestAnimationFrame(() => {
      requestAnimationFrame(() => {
        window.scrollTo(0, 0);
        if (document.documentElement) {
